...
using SampleProject.Rpc.order_service;
using System;
...
{
	public class OrderServiceContent_OrderServiceDTO:DataDTO
	{
		...
		public OrderServiceContent_OrderServiceDTO() { }
		public OrderServiceContent_OrderServiceDTO(OrderService OrderService) {
	...
	public class OrderServiceContent_OrderServiceFilterDTO: FilterDTO
	{
